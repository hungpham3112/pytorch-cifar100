...
class CustomSEResNet(nn.Module):
    def __init__(self, block, block_num, class_num=952):
        ...
        self.linear1 = nn.Linear(self.in_channels, class_num)
...
class CustomBasicResidualSEBlock(nn.Module):
    expansion = 1
...
def custom_seresnet34():
    return CustomSEResNet(CustomBasicResidualSEBlock, [3, 4, 6, 3])
