...
def get_training_dataloader(mean, std, batch_size=16, num_workers=2, shuffle=True, dataset: str="cifar"):
...
def get_test_dataloader(mean, std, batch_size=16, num_workers=2, shuffle=True, dataset: str="cifar"):
...
def get_validation_dataloader(mean, std, batch_size=16, num_workers=2, shuffle=True, dataset: str="cifar"):
    ...
    if dataset.lower() == "cifar":
        val_dataset = torchvision.datasets.CIFAR100(root=data_dir, train=False, download=True, transform=transform_val)
    elif dataset.lower() == "cangjie":
